...
async function main() {
    ...
    await prisma.desbravadorRequisito.deleteMany();
    await prisma.classeRequisito.deleteMany();
    await prisma.classeEntity.deleteMany();
    ...
    const users = [
        ...
        },
        {
            ...
            roles: [client_1.Role.INSTRUTOR],
            unidade: client_1.Unidade.MANASSES,
            classe: null,
        },
        {
            ...
            roles: [client_1.Role.CONSELHEIRO],
            unidade: client_1.Unidade.DA,
            classe: null,
        },
        {
            ...
            name: 'Multi Roles',
            roles: [client_1.Role.INSTRUTOR, client_1.Role.CONSELHEIRO],
            unidade: client_1.Unidade.RUBEN,
            classe: client_1.Classe.PIONEIRO,
        },
    ];
    ...
    const desbravadores = [
        { name: 'João Pereira', birthDate: new Date('2012-04-10'), unidade: client_1.Unidade.DA, classe: client_1.Classe.AMIGO },
        { name: 'Maria Oliveira', birthDate: new Date('2011-09-21'), unidade: client_1.Unidade.ASER, classe: client_1.Classe.COMPANHEIRO },
        { name: 'Carlos Santos', birthDate: new Date('2010-01-05'), unidade: client_1.Unidade.MANASSES, classe: client_1.Classe.PESQUISADOR },
        { name: 'Ana Beatriz', birthDate: new Date('2009-07-30'), unidade: client_1.Unidade.JUDA, classe: client_1.Classe.PIONEIRO },
        { name: 'Pedro Lima', birthDate: new Date('2013-11-12'), unidade: client_1.Unidade.BENJAMIN, classe: client_1.Classe.EXCURSIONISTA },
        { name: 'Luiza Rocha', birthDate: new Date('2008-02-17'), unidade: client_1.Unidade.RUBEN, classe: client_1.Classe.GUIA },
    ];
    for (const d of desbravadores) {
        await prisma.desbravador.create({ data: d });
    }
    await prisma.classeEntity.upsert({
        where: { nome: 'AMIGO' },
        update: {},
        create: {
            nome: 'AMIGO',
